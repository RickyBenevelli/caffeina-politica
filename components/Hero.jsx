  ...
  return (
    <section id='home' className={`bg-gradient-to-br from-[#dc6041] via-[#e6a24f] to-[#dc6041]`}>
        ...
        <div className=' flex flex-col pt-20 lg:pt-[5.5] pb-14 text-slate-900 px-5 lg:px-8'>
            ...
            {/* contenitore eventi */}
            <div className='flex flex-col md:flex-row text-center md:py-5 items-start'>
                {/* colonna di sinistra */}
                <div className='py-4 md:text-xl lg:text-2xl xl:text-2xl md:w-1/2 md:px-3'>
                    ...
                    <div className='font-normal text-xl md:text-2xl lg:text-3xl text-center py-2 md:py-3'>
                        <h3 className='pb-5 font-semibold text-xl md:text-xl lg:text-2xl'>
                            Da giovani per giovani
                        </h3>
                    </div>
                    
                    {/* evento */}
                    <div className='bg-slate-100 lg:mx-20 py-2 px-5 rounded-xl'>
                      <div className='flex flex-row justify-between text-base font-semibold text-gray-800/80 py-1'>
                        <div>
                          Prossimo Evento
                        </div>
                        <div>
                ...
                <div className='md:w-1/3 md:px-3 py-3 m-auto'>
                    ...
                    <div className='py-4'>
                      <h4 className='font-semibold'>APARTITICO E GRATUITO</h4>
                    </div>
                </div>
            </div>
